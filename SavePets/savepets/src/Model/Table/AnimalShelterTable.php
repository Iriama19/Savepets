 ...
 *
 * @method \App\Model\Entity\AnimalShelter newEmptyEntity()
 * @method \App\Model\Entity\AnimalShelter newEntity(array $data, array $options = [])
 * @method \App\Model\Entity\AnimalShelter[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\AnimalShelter get($primaryKey, $options = [])
 * @method \App\Model\Entity\AnimalShelter findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \App\Model\Entity\AnimalShelter patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\AnimalShelter[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\AnimalShelter|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\AnimalShelter saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\AnimalShelter[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\AnimalShelter[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\AnimalShelter[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\AnimalShelter[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
class AnimalShelterTable extends Table
{
    /**
     * Initialize method
     *
