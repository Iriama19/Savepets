                ...
                <?php 
                    ...
                    if($this->Identity->isLoggedIn()){
                      ...
                      $currentuserID=$currentuser->id;
                        ...
                        if($currentuserRol=="admin" || $currentuserID==$publicationHelp->user->id){ ?>
                            /<?= $this->Form->postLink(__('Eliminar'), ['controller' => 'Publication','action' => 'delete', $publicationHelp->publication_id, 'Help'], 
        ...
        <div class="section-content-form">
          ...
          <div class="row">
              <div class="col-xl-6 form-group">
                   <?php echo $this->Form->control('publication.title',['class'=>'form-control','label'=> __('Titulo')]); ?>
              </div>
              <div class="col-xl-6 form-group">
                    <?php 
                        ...
                        echo $this->Form->control('categorie',['class'=>'form-control','label'=> __('Categoria'),'options'=>$opciones, 'value'=>$publicationHelp->categorie]); 
                    ?>
                </div>
            </div>
            <div class="row">
